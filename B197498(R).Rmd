...
# Plot the top 10 words by sentiment
...
for (i in 1:num_iterations) {
  ...
  # Print iteration number and RMSE
  cat("Iteration:", i, "RMSE:", rmse_values[i], "\n")
  
  
  # Replace 'your_model_formula' with your actual formula
  # e.g., dependent_variable ~ predictor1 + predictor2 + ...
  mdl1 <- glm(score ~ sentiment * Dataset, data = train_data)
  
  # Make predictions on the test set
  predictions <- predict(mdl1, newdata = test_data)
  
  # Evaluate model performance (e.g., calculate RMSE or other relevant metrics)
  # store the results or print them as needed
